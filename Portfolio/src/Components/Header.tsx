...
const Header = () => {
  ...
  if (height >= 850 && width >= 1375) {
    // big screen styles
    mainBox = `h-[100vh] w-full flex flex-wrap justify-center z-50`;
    titleStyle = `text-4xl w-full opacity-[50%] text-center m-auto`;
    buttonStyle = `bg-pri/25 cursor-none constellationBox relative shadow-lg shadow-[#555]/50 active:scale-[90%] m-auto py-3 px-14 group text-xl rounded-full linkScroll hover:scale-125 transition duration-200`;
    buttonBox = `flex w-full justify-between `;
    textStyle = `transition duration-500 group-hover:decoration-accent decoration-underline-none underline `;
    constName = `h-[15vw] max-h-[300px] m-auto nameBlur linkScroll anidelay`;
    ...
    mainBox = `h-[100vh] w-full flex flex-wrap justify-center z-50`;
    titleStyle = `text-4xl w-full opacity-[50%] text-center m-auto`;
    buttonStyle = `bg-pri/25 cursor-none constellationBox relative shadow-lg shadow-[#555]/50 active:scale-[90%] m-auto p-3 w-[12%] group text-center text-xl rounded-full linkScroll hover:scale-125 transition duration-200`;
    buttonBox = `flex w-[100%] justify-between m-auto`;
    textStyle = `transition duration-500 group-hover:decoration-accent decoration-underline-none underline `;
    constName = `h-[15vw] max-h-[300px] m-auto nameBlur linkScroll anidelay`;
  }
